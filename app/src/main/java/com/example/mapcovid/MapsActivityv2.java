...
public class MapsActivityv2 extends AppCompatActivity implements OnMapReadyCallback {

    private static final String TAG = MapsActivityv2.class.getSimpleName();
    ...
    public void onMapReady(GoogleMap map) {
        ...
        try {
            ...
            layer.setOnFeatureClickListener(feature -> Toast.makeText(MapsActivityv2.this,
            ...
            placeResult.addOnCompleteListener (new OnCompleteListener<FindCurrentPlaceResponse>() {
                ...
                public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        MapsActivityv2.this.openPlacesDialog();
                    }
                    else {
                        Log.e(TAG, "Exception: %s", task.getException());
                    }
